module github.com/shinzonetwork/shinzo-evm-relayer
...
require (
	...
	github.com/shinzonetwork/shinzohub v0.0.0-20250925215011-8df0a693051b
...
replace github.com/shinzonetwork/shinzohub => ../shinzohub
